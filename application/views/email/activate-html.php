...
<?= nl2br(str_replace('?1', $site_name, $this->lang->line('email_activate_thanks')))?><br />
<br />
<big style="font: 16px/18px Arial, Helvetica, sans-serif;"><b><a href="<?php echo site_url('/auth/activate/'.$user_id.'/'.$new_email_key); ?>" style="color: #3366cc;"><?= $this->lang->line('email_activate_finish') ?></a></b></big><br />
<br />
...
<br />
<?= str_replace('?1', $activation_period, $this->lang->line('email_activate_please'))?><br />
<br />
<br />
