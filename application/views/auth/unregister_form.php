...
$this->lang->load('auth');?>
    ...
    <div class="page-header">
      <h1><?= $this->lang->line('auth_unregister_header') ?><small></small></h1>
    </div>
...
?>
        ...
        <div class="span4">
            <div class="alert alert-error">
                <?php echo $this->lang->line('auth_unregister_info') ?>
            </div><!--/alert-->
        </div><!--/span-->
...
<?php
    echo form_open(base_url('auth/unregister'));
        ...
        $label_text = $this->lang->line('auth_unregister_password_required');
        ...
        echo form_submit($submit_attributes, $this->lang->line('auth_unregister_delete'));
