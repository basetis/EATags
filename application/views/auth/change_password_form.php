...
<table>
	<tr>
		<td><?php echo form_label($this->lang->line('auth_change_password_old'), $old_password['id']); ?></td>
	...
	<tr>
		<td><?php echo form_label($this->lang->line('auth_reset_new_password'), $new_password['id']); ?></td>
	...
	<tr>
		<td><?php echo form_label($this->lang->line('auth_reset_confirm_new_password'), $confirm_new_password['id']); ?></td>
...
<?php echo form_submit('change', $this->lang->line('auth_reset_change_password')); ?>
<?php echo form_close();
